...
static constexpr int64_t STALE_CHECK_INTERVAL = INT64_MAX; // 10 minutes
...
static constexpr int STALE_RELAY_AGE_LIMIT = INT_MAX;
/// Age after which a block is considered historical for purposes of rate
/// limiting block relay. Set to one week, denominated in seconds.
static constexpr int HISTORICAL_BLOCK_AGE = INT_MAX;
