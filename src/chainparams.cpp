...
{
    const char* pszTimestamp = "Boris Johnson resigns as MP with immediate effect over Partygate report";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1686347790, 2906390470, 0x1d00ffff, 1, 50 * COIN);
        //MineGenesis(genesis, consensus.powLimit, false);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000003683d3ff0b38a21cec9c0538347e2988076da95d56cf7a75a5531bbd"));
        assert(genesis.hashMerkleRoot == uint256S("0xdb6337c7e67d7e38b450cec485633ac8cb110e9e2d7586f212ff1b4059a5c12d"));
